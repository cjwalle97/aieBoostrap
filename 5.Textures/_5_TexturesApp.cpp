...
bool _5_TexturesApp::startup() {
	...
	glBufferData(GL_ELEMENT_ARRAY_BUFFER, sizeof(unsigned int) * 6, indexData, GL_STATIC_DRAW); glEnableVertexAttribArray(0); 
...
void _5_TexturesApp::draw() {
	...
	// bind the camera int 
	auto loc = glGetUniformLocation(m_program, "projectionViewWorldMatrix"); 
